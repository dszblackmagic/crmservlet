...
<html>
  <head>
    ...
    <title>My JSP 'serve_file.jsp' starting page</title>
  ...
  <body>
    ...
    <form id="serve-file-fm">
    <input type="hidden" id="currPage" name="currPage">
    <div class="panel-head"><strong class="icon-reorder"> 服务归档	</strong></div>
    <div class="padding border-bottom">
      <ul class="search">
       ...
       <option value="" >全部</option>
        <option value="F" ${qParams['serveState'] eq 'F' ? 'selected="selected"' : ''}>已归档</option>
    ...
    <table class="table table-hover text-center">
      ...
      <!--对营销机会信息进行循环输出 -->  
				...
				<td>
					<a class="button border-blue" onclick="serve_details('${list.serveId}')" href="#">查看</a>	
				</td>
				</c:when>
				<c:otherwise>
				<td colspan="2" >			
					<a class="button border-red" style="cursor:pointer;" onclick="">未归档</a>	
				</td>
				</c:otherwise>
				</c:choose>
  ...
  <script type="text/javascript">
   function serve_list(currPage){
	...
	$('#serve-file-fm').submit();
}

//到达服务归档查看详情
function serve_details(serveId){
	window.location.href="${ctx}/serve/todetails?serveId="+serveId;
}
  </script>
</html>
